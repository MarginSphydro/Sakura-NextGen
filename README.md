<h1 align="center">Sakura-NextGeneration</h1>

<p align="center">
  <a href="https://github.com/NekoyaHouse/Sakura-NextGen/actions"><img alt="Build" src="https://img.shields.io/badge/build-gradle-4c1?style=flat-square"></a>
...
The Graphic rendering system provides custom render pipelines for:
...
See [Graphics README](src/main/java/dev/sakura/client/graphics/README.md) for details.
...
- **Graphics**: The core rendering components (located in `src/main/java/dev/sakura/client/graphics/`)
