package dev.sakura.client.modules.impl.hud.notification;
...
public class NotificationManager {
    ...
    private final TranslateComponent enableComponent = SakuraTranslateComponent.create("modules.notifications hud", "enabled");
    private final TranslateComponent disableComponent = SakuraTranslateComponent.create("modules.notifications hud", "disabled");
