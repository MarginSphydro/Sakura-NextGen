...
import dev.sakura.client.assets.i18n.DefaultTranslateComponent;
...
/**
 * Base class for Sakura addons.
 */
public abstract class SakuraAddon {
    ...
    protected SakuraAddon(String addonId) {
