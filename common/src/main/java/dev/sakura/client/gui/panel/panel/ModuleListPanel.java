...
import dev.sakura.client.gui.panel.adapter.ModuleViewModel;
import dev.sakura.client.gui.panel.component.ModuleRow;
import dev.sakura.client.gui.panel.dsl.PanelUiCompiler;
import dev.sakura.client.gui.panel.dsl.PanelUiTree;
import dev.sakura.client.gui.panel.utils.*;
...
public class ModuleListPanel {
    ...
    private static final TranslateComponent searchComponent = SakuraTranslateComponent.create("gui", "search");
    private static final TranslateComponent modulesComponent = SakuraTranslateComponent.create("gui", "modules");
