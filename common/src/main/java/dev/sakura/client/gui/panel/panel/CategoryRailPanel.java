...
public class CategoryRailPanel {
    ...
    private static final TranslateComponent settingsLabelComponent = SakuraTranslateComponent.create("gui", "clientsettings");
    ...
    public void render(GuiGraphicsExtractor GuiGraphicsExtractor, PanelLayout.Rect bounds, int mouseX, int mouseY, float partialTick) {
        ...
        PanelUiTree tree = PanelUiTree.build(scope -> {
            ...
            if (titleProgress > 0.02f) {
                ...
                scope.text("Sakura " + SakuraClient.VERSION, bounds.x() + 38.0f + titleOffset, titleY, titleScale,
