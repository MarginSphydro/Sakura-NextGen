...
import dev.sakura.client.gui.panel.popup.ConfirmActionPopup;
import dev.sakura.client.gui.panel.popup.MessagePopup;
import dev.sakura.client.gui.panel.popup.PanelPopupHost;
import dev.sakura.client.gui.panel.utils.PanelContentBuffer;
import dev.sakura.client.gui.panel.utils.PanelContentInvalidationState;
import dev.sakura.client.gui.panel.utils.ScrollBarDragState;
import dev.sakura.client.gui.panel.utils.ScrollBarUtils;
...
public class ConfigClientSettingTab implements ClientSettingTabView {
    ...
    private static final TranslateComponent inputPlaceholderComponent = SakuraTranslateComponent.create("gui", "config.input.placeholder");
    private static final TranslateComponent currentComponent = SakuraTranslateComponent.create("gui", "config.current");
    private static final TranslateComponent switchHintComponent = SakuraTranslateComponent.create("gui", "config.switch_hint");
    private static final TranslateComponent emptyComponent = SakuraTranslateComponent.create("gui", "config.empty");
    private static final TranslateComponent saveAsComponent = SakuraTranslateComponent.create("gui", "config.action.saveas");
    private static final TranslateComponent reloadComponent = SakuraTranslateComponent.create("gui", "config.action.reload");
    private static final TranslateComponent exportComponent = SakuraTranslateComponent.create("gui", "config.action.export");
    private static final TranslateComponent importComponent = SakuraTranslateComponent.create("gui", "config.action.import");
    private static final TranslateComponent deleteConfirmTitleComponent = SakuraTranslateComponent.create("gui", "config.delete.confirm.title");
    private static final TranslateComponent deleteConfirmMessageComponent = SakuraTranslateComponent.create("gui", "config.delete.confirm.message");
    private static final TranslateComponent deleteConfirmConfirmComponent = SakuraTranslateComponent.create("gui", "config.delete.confirm.confirm");
    private static final TranslateComponent deleteConfirmCancelComponent = SakuraTranslateComponent.create("gui", "config.delete.confirm.cancel");
    private static final TranslateComponent errorTitleComponent = SakuraTranslateComponent.create("gui", "config.error.title");
    private static final TranslateComponent errorOkComponent = SakuraTranslateComponent.create("gui", "config.error.ok");
    private static final TranslateComponent saveErrorComponent = SakuraTranslateComponent.create("gui", "config.error.save");
    private static final TranslateComponent reloadErrorComponent = SakuraTranslateComponent.create("gui", "config.error.reload");
    private static final TranslateComponent exportErrorComponent = SakuraTranslateComponent.create("gui", "config.error.export");
    private static final TranslateComponent importErrorComponent = SakuraTranslateComponent.create("gui", "config.error.import");
    private static final TranslateComponent switchErrorComponent = SakuraTranslateComponent.create("gui", "config.error.switch");
    private static final TranslateComponent deleteErrorComponent = SakuraTranslateComponent.create("gui", "config.error.delete");
    private static final TranslateComponent deleteLastErrorComponent = SakuraTranslateComponent.create("gui", "config.error.delete_last");
    private static final TranslateComponent exportSuccessTitleComponent = SakuraTranslateComponent.create("gui", "config.export.success.title");
    private static final TranslateComponent exportSuccessMessageComponent = SakuraTranslateComponent.create("gui", "config.export.success.message");
    ...
    private void trySaveAs() {
        ...
        try {
            ...
            SakuraClient.LOGGER.error("保存配置失败", exception);
    ...
    private void tryReload() {
        try {
            ...
            SakuraClient.LOGGER.error("重载配置失败", exception);
    ...
    private void tryExport() {
        try {
            ...
            SakuraClient.LOGGER.error("导出配置失败", exception);
    ...
    private void trySwitchConfig(String configName) {
        ...
        try {
            ...
            SakuraClient.LOGGER.error("切换配置失败", exception);
    ...
    private void tryDeleteConfig(String configName) {
        try {
            ...
            SakuraClient.LOGGER.error("删除配置失败", exception);
