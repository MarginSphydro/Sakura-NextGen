...
import dev.sakura.client.managers.FriendManager;
...
public class FriendClientSettingTab implements ClientSettingTabView {
    ...
    private static final TranslateComponent noFriendsComponent = SakuraTranslateComponent.create("gui", "friend.empty");
    private static final TranslateComponent addFriendPlaceholderComponent = SakuraTranslateComponent.create("gui", "friend.input.placeholder");
