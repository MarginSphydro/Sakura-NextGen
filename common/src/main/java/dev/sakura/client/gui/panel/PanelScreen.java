package dev.sakura.client.gui.panel;
...
import dev.sakura.client.gui.panel.dsl.PanelRenderBatch;
import dev.sakura.client.gui.panel.input.PanelInputRouter;
import dev.sakura.client.gui.panel.panel.CategoryRailPanel;
import dev.sakura.client.gui.panel.panel.ClientSettingPanel;
import dev.sakura.client.gui.panel.panel.ModuleDetailPanel;
import dev.sakura.client.gui.panel.panel.ModuleListPanel;
import dev.sakura.client.gui.panel.popup.PanelPopupHost;
import dev.sakura.client.gui.panel.utils.IMEFocusHelper;
...
public class PanelScreen extends Screen {
    ...
    private SakuraRenderSystem.SakuraRenderTarget renderTarget;
    ...
    public void extractRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (renderTarget == null) {
            renderTarget = SakuraRenderSystem.SakuraRenderTarget.create("click-gui", window.getWidth(), window.getHeight());
        }
        renderTarget.clear();
        renderTarget.resize(window.getWidth(), window.getHeight());

        SakuraRenderSystem.setActiveTarget(renderTarget);
        ...
        SakuraRenderSystem.setActiveTarget(null);
     ...
     */
    public SakuraRenderSystem.SakuraRenderTarget getRenderTarget() {
        return renderTarget;
    }
}
