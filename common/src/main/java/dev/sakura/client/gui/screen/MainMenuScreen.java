package dev.sakura.client.gui.screen;
...
import dev.sakura.client.graphics.video.VideoManager;
import dev.sakura.client.graphics.video.VideoUtil;
...
public class MainMenuScreen extends Screen {
    ...
    private MainMenuScreen() {
        ...
        entries.add(new MenuEntry("Q", "Quit", "Leave Sakura and close the game", minecraft::stop));
    }
    ...
    public void added() {
        ...
        try {
            ...
            SakuraClient.LOGGER.error("MainMenu视频加载失败!", e);
        }
    }
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        if (renderTarget == null) {
            renderTarget = SakuraRenderSystem.SakuraRenderTarget.create("main-menu", window.getWidth(), window.getHeight());
        }
    ...
    private void drawMenu(int mouseX, int mouseY) {
        ...
        textRenderer.addText("Sakura", layout.panelX + layout.padding, titleY, titleScale, titleColor, StaticFontLoader.DUCKSANS);
        textRenderer.addText("Minecraft 26.1.2  |  " + SakuraClient.VERSION, layout.panelX + layout.padding, subtitleY, versionScale, subtitleColor);
