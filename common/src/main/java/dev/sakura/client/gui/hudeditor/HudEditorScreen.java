...
import dev.sakura.client.modules.impl.hud.notification.NotificationManager;
...
public class HudEditorScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        if (renderTarget == null) {
            renderTarget = SakuraRenderSystem.SakuraRenderTarget.create("hud-editor", window.getWidth(), window.getHeight());
        }
        renderTarget.clear();
