...
public class HudEditorInspector {
    ...
    private static final TranslateComponent titleComponent = SakuraTranslateComponent.create("gui", "inspector");
    private static final TranslateComponent selectComponent = SakuraTranslateComponent.create("gui", "inspector.select");
