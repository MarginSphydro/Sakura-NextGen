...
public class ModuleDetailPanel {
    ...
    private static final TranslateComponent toggleComponent = SakuraTranslateComponent.create("keybind", "toggle");
    private static final TranslateComponent holdComponent = SakuraTranslateComponent.create("keybind", "hold");
    private static final TranslateComponent noneComponent = SakuraTranslateComponent.create("keybind", "none");
    private static final TranslateComponent visibleComponent = SakuraTranslateComponent.create("module", "visible");
    private static final TranslateComponent hiddenComponent = SakuraTranslateComponent.create("module", "hidden");
    private static final TranslateComponent noModuleComponent = SakuraTranslateComponent.create("gui", "no_module");
