package dev.sakura.client.graphics.buffer;
...
public class SakuraRingBuffer {
    ...
    public SakuraRingBuffer(long size, @GpuBuffer.Usage int usage) {
        ringBuffer = new MappableRingBuffer(() -> "sakura-ring-buffer",
