...
public class SakuraRenderSystem {

    public static final Projection guiOrthoProjection = new Projection();

    private static final ProjectionMatrixBuffer guiProjectionMatrixBuffer = new ProjectionMatrixBuffer("sakura-gui");

    private static SakuraRenderTarget activeTarget = null;

    public static void setActiveTarget(SakuraRenderTarget target) {
        activeTarget = target;
    }

    public static SakuraRenderTarget getActiveTarget() {
        return activeTarget;
    }
    ...
    public static final class SakuraRenderTarget implements AutoCloseable {

        private SakuraTexture colorTexture;
        ...
        private SakuraRenderTarget(String name, int width, int height) {
            this.width = width;
            this.height = height;
            this.identifier = ResourceLocationUtils.getIdentifier("sakura-rt" + name);
            createTextures();
        }

        public static SakuraRenderTarget create(String name, int width, int height) {
            return new SakuraRenderTarget(name, width, height);
        }
        ...
        private void createTextures() {
            ...
            this.colorTexture = new SakuraTexture(colorTexture, colorView, sampler);
        ...
        public SakuraTexture getColorTexture() {
            return colorTexture;
        }
