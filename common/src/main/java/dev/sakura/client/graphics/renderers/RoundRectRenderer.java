...
import dev.sakura.client.graphics.elements.RoundRectElement;
...
public class RoundRectRenderer implements IRenderer {
    ...
    private final SakuraRingBuffer buffer = new SakuraRingBuffer(BUFFER_SIZE, GpuBuffer.USAGE_VERTEX);
    ...
    public void draw() {
        ...
        SakuraRenderSystem.QuadRenderingInfo info = SakuraRenderSystem.prepareQuadRendering(vertexCount);
        ...
        try (RenderPass pass = RenderSystem.getDevice().createCommandEncoder().createRenderPass(
            ...
            pass.setPipeline(SakuraRenderPipelines.ROUND_RECT);
