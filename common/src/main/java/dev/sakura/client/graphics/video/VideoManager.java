...
public class VideoManager {
    ...
    private static void unpackFile(File file, String name) throws IOException {
        ...
        IOUtils.copy(Objects.requireNonNull(SakuraClient.class.getClassLoader().getResourceAsStream(name)), fos);
        fos.close();
    }
    ...
    public static void ensureBackgroundFile() throws IOException {
        ...
        if (!backgroundFile.exists()) {
            unpackFile(backgroundFile, "assets/sakura/background/wallpaper.mp4");
        }
    }
