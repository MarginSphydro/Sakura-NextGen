package dev.sakura.client.graphics.video;
...
public class VideoUtil {
    ...
    public static void init(File file, int fps) {
        ...
        try {
            SakuraClient.LOGGER.info("[VideoPlayer] Initializing... {}", file.getAbsolutePath());
            ...
            SakuraClient.LOGGER.error("[VideoPlayer] Init error:", e);
            stop();
        }
    }
    ...
    public static void stop() {
        try {
            ...
            SakuraClient.LOGGER.info("[VideoPlayer] Stopped");
        } catch (Throwable e) {
            SakuraClient.LOGGER.error("[VideoPlayer] Stop error:", e);
        }
    }
    ...
    private static void startDecodeThread() {
        decodeFuture = executor.submit(() -> {
            try {
                ...
                SakuraClient.LOGGER.error("[VideoPlayer] Decode thread error:", e);
            }
        });
    }
