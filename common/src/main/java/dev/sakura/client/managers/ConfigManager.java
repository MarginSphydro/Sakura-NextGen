...
public class ConfigManager {
    ...
    private static final Path configDir = Paths.get(System.getProperty("user.home"), "Sakura-NextGen");
    ...
    public void initConfig() {
        try {
            ...
            SakuraClient.LOGGER.error("初始化配置失败", e);
        }
    }
    ...
    public synchronized List<String> listConfigs() {
        try {
            ...
            SakuraClient.LOGGER.error("列出配置失败", e);
    ...
    public synchronized void reload() {
        try {
            ...
            SakuraClient.LOGGER.error("重载配置失败", e);
        }
    }
    ...
    public synchronized void saveNow() {
        try {
            ...
            SakuraClient.LOGGER.error("保存配置失败", e);
        }
    }
    ...
    private void applyModuleFromDisk(Module module, Path configStorageDir) {
        ...
        try {
            ...
            SakuraClient.LOGGER.error("读取模块配置失败: {}", file, e);
        }
    }
    ...
    private void saveModuleToDisk(Module module, Path configStorageDir) throws IOException {
        ...
        try {
            ...
            SakuraClient.LOGGER.error("写入模块配置失败: {}", file, e);
            throw e;
        }
    }
    ...
    private synchronized void saveFriends(Path configStorageDir) throws IOException {
        ...
        try {
            ...
            SakuraClient.LOGGER.error("写入好友文件失败: {}", friendFile, e);
            throw e;
        }
    }
    ...
    private synchronized void loadFriends(Path configStorageDir) {
        ...
        try {
            ...
            SakuraClient.LOGGER.error("读取好友文件失败: {}", friendFile, e);
        }
    }
